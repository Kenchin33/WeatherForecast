...
function DailyForecast() {
  ...
  return (
    <div className="pt-6 pb-5 px-4 h-[12rem] border rounded-lg flex flex-col gap-8 dark:bg-dark shadow-sm dark:shadow-none col-span-full border-light-mode-color dark:border-dark-mode-color"
    >
